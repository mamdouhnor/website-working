          ...
          <div className="services-content">
            ...
            <div className="services-image">
              <div className="salt-showcase">
                <img src="/images/products/bo7era.jpg" alt="Premium Salt Products" className="showcase-main" />
                <img src="/images/products/bo7era2.jpg" alt="Salt Production" className="showcase-secondary" />
              </div>
            </div>
          </div>
        </div>
